...
export default function Sales() {
  ...
  function tableSubmit(e) {
    ...
    if (
      persoanlData.date === "" &&
      persoanlData.customer === "" &&
      persoanlData.mobileno === ""
    ) {
      alert("fill Properly!!!!");
    } else {
      navigate("/saletable");
      ...
      axios
        .post(
          "https://65979d8c668d248edf230fd9.mockapi.io/sale_table",
          postData
        )
        .then((res) => {
  ...
  function loadData() {
    axios
      .get("https://65979d8c668d248edf230fd9.mockapi.io/crud")
      .then((res) => {
